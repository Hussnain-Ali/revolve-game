      ...
      >
        <div class="SideBar_sideBarWrapper__928Mk">
          ...
          <div class="SideBar_navLinksWrapper__RT3C9">
            ...
            <a class="SideBar_sideBarLink__2umRc" href="/liquidityStaking">
              <img
                src={liquidityLogo}
                alt="Sidebar icon"
                class="SideBar_sideBarLogo__2_o8z"
            ...
            <a class="SideBar_sideBarLink__2umRc" href="/nft-generate">
              <img
                src={generateLogo}
                alt="Sidebar icon"
                class="SideBar_sideBarLogo__2_o8z"
            ...
            <a class="SideBar_sideBarLink__2umRc" href="/inventory">
              <img
                src={invLogo}
                alt="Sidebar icon"
                class="SideBar_sideBarLogo__2_o8z"
            ...
            <a class="SideBar_sideBarLink__2umRc" href="/game">
              <img
                src={gamelogo}
                alt="Sidebar icon"
                class="SideBar_sideBarLogo__2_o8z"
            ...
            <a class="SideBar_sideBarLink__2umRc" href="/analytics">
              <img
                src={analyticsLogo}
                alt="Sidebar icon"
                class="SideBar_sideBarLogo__2_o8z"
          ...
          <div class="SideBar_sideBarLowerLinkWrapper__3UCUG">
            <a
              ...
              class="SideBar_sideBarLowerLink__2AlsD"
            >
              Whitepaper
            </a>
          </div>
